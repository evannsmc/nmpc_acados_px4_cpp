...
ros2 run nmpc_acados_px4_cpp run_node --platform hw --trajectory fig8_akash
ros2 run nmpc_acados_px4_cpp run_node --platform hw --trajectory fig8_akash --ff
```
...
# Auto-generated filename: sim_nmpc_acados_px4_fig8_akash_ff_1x_cpp.csv
ros2 run nmpc_acados_px4_cpp run_node --platform sim --trajectory fig8_akash --ff --log

# Hardware with custom filename
ros2 run nmpc_acados_px4_cpp run_node \
  --platform hw \
  --trajectory fig8_akash \
  --ff \
  --log \
...
| `--ff`             | No       | flag | Differential-flatness feedforward (only valid with `fig8_akash`) |
