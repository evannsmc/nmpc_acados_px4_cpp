...
C++ port of [`nmpc_acados_px4`](https://github.com/evannsmc/nmpc_acados_px4) — a ROS 2 Nonlinear Model Predictive Controller (NMPC) for quadrotors using the [Acados](https://docs.acados.org/) solver. It reuses the same Euler-state formulation, error-based cost, and `atan2`-based wrapped yaw error as the Python package, implemented in C++ directly against the Acados C API for minimal solve overhead.
...
**[<kbd> <br> Build Order <br> </kbd>](#build-order-do-this-first)** 
...
- [Build Order (Do This First)](#build-order-do-this-first)
  - [Step 1 — Generate or verify the Acados C solver](#step-1--generate-or-verify-the-acados-c-solver)
  - [Step 2 — Build the C++ package](#step-2--build-the-c-package)
...
- [Acados Installation](#acados-installation)
